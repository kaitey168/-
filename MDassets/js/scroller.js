(function($) {
	$.fn.navbarscroll = function(options) {
		...
		this.each(function() {
			...
			var _obj_scroller = _wrapper.children('.van-tabs__wrap--scrollable');
			var _obj_ul = _obj_scroller.children('ul');
			var _obj_li = _obj_ul.children('a');
			var _scroller_w = 0;
			_obj_li.css({
				"margin-left": "0",
				"margin-right": "0"
			...
			function _init(thiObj) {
				...
				var duibi = _opt.duibiScreenWidth * _win_width / 10,
					...
					this_prev_width = $this_obj.prev('a').width(),
					this_next_width = $this_obj.next('a').width();
				...
				$this_obj.addClass(_opt.className).siblings('a').removeClass(_opt.className);
